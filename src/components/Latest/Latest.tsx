...
const Latest = () => {
    return (
        <>
            <LeftAsideNav />
            <div id="latest-section" className="">
                ...
                <div id="articles-content-container">
                    <div id="" className="article">
                        ...
                        <NavLink to="/article-title" className="article-title-link">
                        ...
                        <ol id="" className="article-tags">
                            <li className="article-tag-item">Serverless Functions</li>
                            <li className="article-tag-item">Vercel</li>
